...
public class SensorService {
    ...
    public List<QueryResult.Result> selectDataSensor(String kitId, String sensor) {
        String queryStr = String.format("SELECT * FROM %s where kit_id = %s and time > now() - 1m", sensor, kitId);
